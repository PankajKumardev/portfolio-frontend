      ...
      <div className="fixed bottom-0 left-0 right-0 flex justify-center   md:block md:justify-center md:flex  lg:block lg:justify-center lg:flex">
        <div className="  box-border md:h-18  sm:h-18 d:w-[22%] border-2 border-[#262626] rounded-full mb-10 bg-[#1d1d1d] transition-transform duration-300 transform hover:scale-105">
          ...
          <div className="flex">
            ...
            <div className="h-10 w-0.5 bg-[#454545] mx-2 my-2"></div>
            <a href="https://github.com/PankajKumardev" target="_blank" className="mt-4 hover:scale-110 transition-transform duration-300">
              <svg viewBox="0 0 438.549 438.549" className="w-10 h-6">
                <path
                  fill="currentColor"
            ...
            <a href="https://www.linkedin.com/in/pankajkumardev0/" target="_blank" className="mt-4 ml-3 hover:scale-110 transition-transform duration-300">
              <svg
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                className="w-10 h-6"
            ...
            <a href="https://x.com/Pankajkumar_dev" target="_blan" className="mt-4 ml-3 hover:scale-110 transition-transform duration-300">
              <svg
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                className="w-10 h-6"
